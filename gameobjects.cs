...
namespace asciiadventure
{
    ...
    //add new gameObject Heart as an extra life for the player, if player catch the heart, it wins 
    class Heart : GameObject
    {
        public Heart(int row, int col, Screen screen) : base(row, col, "H", screen) { }
